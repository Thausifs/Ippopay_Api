...
function onError(error) {
  ...
  switch (error.code) {
    case 'EACCES':
      _logger["default"].error("\uD83D\uDD34 ".concat(bind, " requires elevated privileges"));
      process.exit(1);
    case 'EADDRINUSE':
      _logger["default"].error("\uD83D\uDD34 ".concat(bind, " is already in use"));
      process.exit(1);
    default:
      throw error;
  }
...
_index["default"].initializeRoutes(app);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          next(_httpErrors["default"].NotFound('This router does not exist'));
        case 1:
        case "end":
...
app.use(function (err, req, res, next) {
  return (0, _requestHandler.handleError)({
    res: res,
...
var host = process.env.HOST_URL || 'http://localhost';
  ...
  server.listen(port, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _logger["default"].info("\uD83D\uDE80 Running on ".concat(process.pid, " @ ").concat(host, ":").concat(port));
          _context2.next = 3;
          return (0, _db.setupConnection)();
        case 3:
        case "end":
...
process.on('SIGINT', function () {
  // grace shutdown
  _logger["default"].info('✔️  SIGINT received');
  server.close(function () {
    _logger["default"].info('✔️  Server is close...');
...
process.on('SIGTERM', function () {
  _logger["default"].info('✔️  SIGTERM received');
  server.close(function () {
    _logger["default"].info('✔️  Server is close...');
    _mongoose["default"].connection.close(false, function () {
      process.exit(0);
