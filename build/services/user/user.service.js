...
var _user = _interopRequireDefault(require("../../db/models/user/user"));
...
var UserService = /*#__PURE__*/function () {
  ...
  _createClass(UserService, [{
    key: "registeruser",
    value: function () {
      var _registeruser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
        var admin, salt, create;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _logger["default"].info('inside user registration service');
              _context.prev = 1;
              _context.next = 4;
